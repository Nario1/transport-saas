            ...
            <form action="{{ route('conductores.store') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tipo_licencia" value="{{ old('tipo_licencia') }}" class="form-control"
                            placeholder="Ej: AIIB" required>
                    </div>
                    <div class="form-group">
                        <label>Vencimiento de Licencia</label>
                        <input type="date" name="licencia_vence" value="{{ old('licencia_vence') }}"
                            class="form-control">
                    </div>
                    <div class="form-group">
                ...
                <div style="margin-top: 25px; text-align: right; gap: 10px; display: flex; justify-content: flex-end;">
                    ...
                    <button type="submit" class="btn-primary" style="padding: 10px 30px;">Guardar Conductor</button>
                </div>
            </form>
        </div>
    </div>
